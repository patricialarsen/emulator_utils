...
def shap_estimate(predictor, training_data, test_data, input_names, output_names):  
...
def plot_shap_summary_single(shap_values_single, test_data, input_names, output_names, plot_type):   
    p1 = shap.summary_plot(shap_values_single, test_data, feature_names = input_names, class_names=output_names, plot_type=plot_type)

    
def plot_shap_summary_multiple(shap_values, test_data, input_names, output_names, plot_type):
    p2 = shap.summary_plot(shap_values, test_data, feature_names = input_names, class_names=output_names, plot_type=plot_type)
...
def global_explainer(predictor, training_data, test_data, input_names, output_names):
    """
